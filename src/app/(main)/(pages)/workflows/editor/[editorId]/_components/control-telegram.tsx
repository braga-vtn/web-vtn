...
import { fetchControlTelegramData, updateControlTelegramData } from '../../../_actions/controlTelegramRequest';
...
const ControlTelegram = ({ node, onExample }: Props) => {
  ...
  useEffect(() => {
    fetchControlTelegramData().then(data => {
      setSelectValues({
  ...
  const handleSave = () => {
    ...
    updateControlTelegramData(data);
  ...
  return (
    <div>
      {telegramData?.connectedTelegram ?
        <>
          ...
          <CardContent>
            <Alert>
              ...
              <AlertDescription className='text-muted-foreground text-xs'>
                Seu Telegram ainda não está integrado à Vistune.
              </AlertDescription>
            </Alert>
          </CardContent>
          <CardFooter className="mt-2">
...
export default ControlTelegram;