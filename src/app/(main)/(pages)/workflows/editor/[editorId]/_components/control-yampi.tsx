          ...
          <CardContent>
            <Alert>
              ...
              <AlertDescription className='text-muted-foreground text-xs'>
                Tudo certo com sua integração com a Yampi. Não há mais configurações no momento!
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
        ...
        <Card className="w-full h-full border-hidden">
          <CardContent>
            <Alert>
              ...
              <AlertDescription className='text-muted-foreground text-xs'>
                Sua conta Yampi ainda não está integrado à Vistune.
              </AlertDescription>
            </Alert>
          </CardContent>
