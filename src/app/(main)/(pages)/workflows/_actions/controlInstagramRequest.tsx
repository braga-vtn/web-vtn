...
type ControlInstagramData = SelectValuesType & { openingHours: OpeningHoursType };

let requestResult: Promise<ControlInstagramData> | null = null;

export const fetchControlInstagramData = (): Promise<ControlInstagramData> => {
...
export const updateControlInstagramData = (newData: ControlInstagramData): void => {
