...
CREATE TABLE "User" (
    ...
    "creditwpp" INTEGER DEFAULT 0,

    CONSTRAINT "User_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "VistuneTools" (
    "id" TEXT NOT NULL,
    "acessToken" TEXT NOT NULL,
    "blackList" BOOLEAN NOT NULL DEFAULT false,
    "plan" TEXT NOT NULL DEFAULT 'free',
    "tier" INTEGER DEFAULT 1,
    "counterHistory" INTEGER DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "userId" TEXT NOT NULL,

    CONSTRAINT "VistuneTools_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "WhatsappConnection" (
    ...
    "token" TEXT NOT NULL,
    "phoneConnected" TEXT,
    "webhookSendMessage" TEXT,
    "webhookReceivedMessage" TEXT,
    "webhookConnected" TEXT,
    "webhookDisconnected" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "userId" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "VistuneTools_acessToken_key" ON "VistuneTools"("acessToken");
...
-- AddForeignKey
ALTER TABLE "VistuneTools" ADD CONSTRAINT "VistuneTools_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("clerkId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WhatsappConnection" ADD CONSTRAINT "WhatsappConnection_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("clerkId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Tasks" ADD CONSTRAINT "Tasks_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("clerkId") ON DELETE RESTRICT ON UPDATE CASCADE;
